...
(define (cc amount kinds-of-coins depth parent)
  ...
  (display (string-append (cc-id amount kinds-of-coins depth)  " [label=\"" (cc-label amount kinds-of-coins) "\"," (if (= amount 0) "color=gray80" " ") "];") )
  (newline)
  (cond ((= amount 0) 1);
        ((or (< amount 0) 
             (= kinds-of-coins 0))
...
(display "graph [ranksep=0.3];") (newline)
